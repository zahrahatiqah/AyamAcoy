                    ...
                    <div class="card-body invoice-head">
                        <div class="row">
                            <div class="col-md-4 align-self-center">
                                <img src="\ayamacoy\logo_yellow_page-0001-removebg-preview.png" alt="logo-small" class="logo-sm me-1" height="40">
                                <img src="\ayamacoy\logo_yellow_page-0001-removebg-preview.png" alt="logo-large" class="logo-lg brand-light"
                                    height="16">
                                ...
                                <ul class="list-inline mb-0 contact-detail float-end">
                                    <li class="list-inline-item">
                                        <div class="ps-3">
                                            ...
                                            <p class="text-muted mb-0">www.Ayam_Acoy.com</p>
                                        </div>
                                    </li>
                                    <li class="list-inline-item">
                                        <div class="ps-3">
                                            <i class="mdi mdi-phone"></i>
                                            <p class="text-muted mb-0">081292093951</p>
                                        </div>
                                    </li>
                                    <li class="list-inline-item">
                                        <div class="ps-3">
                                            <i class="mdi mdi-map-marker"></i>
                                            <p class="text-muted mb-0">14130 Jakarta, Indonesia</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="col-md-3 d-print-flex">
                                <div class="">
                                    <address class="font-13">
                                        ...
                                        Kp Sungai Begog<br>
                                        RT.01/RW.02 No.54
                                        Kec. Cilincing Kel. Semper Timur, Jakarta Utara<br>
                                        <abbr title="Phone">No. Telp:</abbr> 0812-9209-3951
                                    </address>
                                </div>
                            </div>
                            <!--end col-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 align-self-center">
                                <div class="float-none float-md-end" style="width: 30%;">
                                    <small>Ayam Acoy</small>
                                    <img src="\ayamacoy\logo_yellow_page-0001-removebg-preview.png" alt="" class="mt-2 mb-1"
                                        height="20">
                                </div>
                            </div>
                            <!--end col-->
