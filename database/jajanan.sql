...
CREATE TABLE `kategori` (
  ...
  `deskripsi_kategori` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `pesanan` (
  ...
  `id_user` int NOT NULL,
  `quantity` int NOT NULL,
  `harga_total_bayar` int NOT NULL,
  `ongkir` int NOT NULL,
  `total_ongkir` int NOT NULL,
...
CREATE TABLE `rekening` (
  ...
  `jenis_rekening` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
(1, 'admin anita', 'admin@admin.com', '2022-11-05 07:44:53', '$2y$10$aDJc9xYb11Udc98ri0GYuehzI8XrpiOV2lMgr3Je7/2d3xRSHoRpm', 'admin', '086593900_1553668873-LISA_BLACKPINK_1.jpg', '081218113193', 'dGjOpzmulTDQehb9UqGn6UgFSDnu9Cem5pQNCC7Gpi54vLBCN0dNyhGmsxkL', '2022-11-05 07:44:53', '2022-11-05 16:47:45'),
...
--
ALTER TABLE `alamat_user`
  MODIFY `id_alamat` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `chat`
--
ALTER TABLE `chat`
  MODIFY `id_pesan` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `keranjang`
  MODIFY `id_keranjang` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `komentar`
--
ALTER TABLE `komentar`
  MODIFY `id_komentar` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `pesanan`
  MODIFY `id_pesanan` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `rekening`
  MODIFY `id_rekening` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `resi`
--
ALTER TABLE `resi`
  MODIFY `id_resi` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
